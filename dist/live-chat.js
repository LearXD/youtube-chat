...
var _LiveChat_instances, _LiveChat_observer, _LiveChat_options, _LiveChat_paused, _LiveChat_interval, _LiveChat_id, _LiveChat_execute;
...
class LiveChat extends events_1.EventEmitter {
    constructor(id, interval = 1000) {
        ...
        _LiveChat_paused.set(this, false);
    ...
    pause() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!__classPrivateFieldGet(this, _LiveChat_paused, "f")) {
                __classPrivateFieldSet(this, _LiveChat_paused, true, "f");
            }
        });
    }
    resume() {
        return __awaiter(this, void 0, void 0, function* () {
            if (__classPrivateFieldGet(this, _LiveChat_paused, "f")) {
                __classPrivateFieldSet(this, _LiveChat_paused, false, "f");
            }
        });
    }
    isPaused() {
...
_LiveChat_observer = new WeakMap(), _LiveChat_options = new WeakMap(), _LiveChat_paused = new WeakMap(), _LiveChat_interval = new WeakMap(), _LiveChat_id = new WeakMap(), _LiveChat_instances = new WeakSet(), _LiveChat_execute = function _LiveChat_execute() {
    return __awaiter(this, void 0, void 0, function* () {
